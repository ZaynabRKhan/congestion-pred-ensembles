...
def build_dataset(opt):
    ...
    if opt['test_mode']:
        ...
        return IterLoader(DataLoader(dataset=dataset, num_workers=4, batch_size=opt.pop('batch_size'), shuffle=True, drop_last=True, pin_memory=False)) #default num_workers=16 and pin_memory=False
